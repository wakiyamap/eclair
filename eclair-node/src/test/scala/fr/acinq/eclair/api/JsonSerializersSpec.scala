...
class JsonSerializersSpec extends AnyFunSuite with Matchers {
  ...
  test("deserialize Map[OutPoint, ByteVector]") {
    val output1 = new OutPoint(new ByteVector32("11418a2d282a40461966e4f578e1fdf633ad15c1b7fb3e771d14361127233be1"), 0)
    val output2 = new OutPoint(new ByteVector32("3d62bd4f71dc63798418e59efbc7532380c900b5e79db3a5521374b161dd0e33"), 1)
    val map = Map(
      output1 -> hex"dead",
      output2 -> hex"beef"
    )
  ...
  test("DirectedHtlc serialization") {
    val add = UpdateAddHtlc(
      channelId = new ByteVector32("345b2b05ec046ffe0c14d3b61838c79980713ad1cf8ae7a45c172ce90c9c0b9f"),
      id = 926,
      amountMsat = 12365.msat,
      paymentHash = new ByteVector32("9fcd45bbaa09c60c991ac0425704163c3f3d2d683c789fa409455b9c97792692"),
      ...
      onionRoutingPacket = OnionRoutingPacket(
        ...
        hmac = new ByteVector32("9442626f72c475963dbddf8a57ab2cef3013eb3d6a5e8afbea9e631dac4481f5")
      )
    )
  ...
  test("HTLC origin serialization") {
    ...
    val channelOrigin = Origin.ChannelRelayedCold(new ByteVector32("345b2b05ec046ffe0c14d3b61838c79980713ad1cf8ae7a45c172ce90c9c0b9f"), 7, 500 msat, 400 msat)
    ...
    val trampolineOrigin = Origin.TrampolineRelayedCold((new ByteVector32("9fcd45bbaa09c60c991ac0425704163c3f3d2d683c789fa409455b9c97792692"), 3L) :: (new ByteVector32("70685ca81a8e4d4d01beec5781f4cc924684072ae52c507f8ebe9daf0caaab7b"), 7L) :: Nil)
