...
class LightningMessageCodecsSpec extends FunSuite {
  ...
  test("non-reg pay-to-open") {
    ...
    val p = PayToOpenRequest(randomBytes32, 12 mbtc, 12345 msat, 7 sat, randomBytes32, Some(UpdateAddHtlc(randomBytes32, 42, 12345 msat, randomBytes32, CltvExpiry(420), TestConstants.emptyOnionPacket)))
