...
object TorProtocolHandler {
  ...
  case class SafeCookie(nonce: ByteVector = ByteVector.view(fr.acinq.eclair.randomBytes32.toByteArray)) extends Authentication { override def toString = "safecookie" }
  // @formatter:on
