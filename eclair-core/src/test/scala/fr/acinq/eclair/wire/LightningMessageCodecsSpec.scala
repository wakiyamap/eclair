...
class LightningMessageCodecsSpec extends AnyFunSuite {
  ...
  def scalar(fill: Byte) = new PrivateKey(bin32(fill))

  def point(fill: Byte) = scalar(fill).publicKey

  def publicKey(fill: Byte) = point(fill)
  ...
  test("decode channel_update with htlc_maximum_msat") {
    ...
    assert(update === ChannelUpdate(new ByteVector64("58fff7d0e987e2cdd560e3bb5a046b4efe7b26c969c2f51da1dceec7bcb8ae1b634790503d5290c1a6c51d681cf8f4211d27ed33a257dcc1102862571bf17923"), new ByteVector32("06226e46111a0b59caaf126043eb5bbf28c34f3a5e332a1fc7b2b73cf188910f"), ShortChannelId(0x5a10000020000L), 1539791129, 1, 1, CltvExpiryDelta(6), 1 msat, 1 msat, 10, Some(980000000 msat)))
